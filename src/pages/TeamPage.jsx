...
const MEMBERS = [
    {
        name: 'Club Lead',
        role: 'Club Head',
        bio: 'Leads the AWS Cloud Club Atria community and drives initiatives that help students learn and build with cloud technologies.',
        imageSrc: '/images/members/head1.webp',
        featured: true,
    },
    {
        name: 'Builder',
        role: 'Cloud Builder',
        bio: 'Focused on learning AWS services and contributing to technical workshops and community projects.',
        imageSrc: '/images/members/head2.webp',
        featured: false,
    },
    {
        name: 'Builder',
        role: 'Developer',
        bio: 'Interested in cloud infrastructure, backend systems, and collaborative development within the club.',
        imageSrc: '/images/members/head3.webp',
        featured: false,
    },
];
                    ...
                    <ScrollReveal>
                        <div className="text-center">
                            ...
                            <h1 className="text-5xl md:text-7xl lg:text-9xl font-black text-text-primary dark:text-white leading-[0.9] tracking-tighter">
                                MEET THE
                                <br />
                                <span className="text-gradient-purple-orange">TEAM</span>
                            </h1>
                            <p className="mt-8 text-xl text-text-secondary dark:text-text-dark-secondary max-w-3xl mx-auto font-medium">
                                ...
                                The passionate builders behind AWS Cloud Club Atria who organize events, build projects, and grow the cloud community.
                            </p>
                        </div>
                    </ScrollReveal>
                </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <ScrollReveal delay={200}>
                        <p className="mt-6 text-xl text-text-secondary dark:text-text-dark-secondary">
                            ...
                            Become part of AWS Cloud Club Atria and start building your journey in cloud computing.
                        </p>
                    </ScrollReveal>
