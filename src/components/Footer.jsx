 ...
 * Phantom email removed.
 */
export default function Footer() {
    const currentYear = new Date().getFullYear();

    return (
        <footer className="bg-amazon-navy dark:bg-black text-white">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link
                                    to="/about"
                                    className="text-sm text-gray-300 hover:text-amazon-orange transition-colors duration-300"
                                >
                                    About Us
                                </Link>
                            </li>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <a
                                ...
                                rel="noopener noreferrer"
                                aria-label="LinkedIn"
                                className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-amazon-orange hover:scale-110 transition-all duration-300"
                            >
